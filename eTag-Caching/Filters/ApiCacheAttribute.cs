...
namespace eTag_Caching.Caching
{
    ...
    //        {
    //            object o = System.Runtime.Caching.MemoryCache.Default.Get(this.CacheKey.ToString());
    //            if (null != o && null != actionContext.Request.Headers.IfNoneMatch)
    //            {
    //                string etag = o.ToString();
    //                if (actionContext.Request.Headers.IfNoneMatch.Any(x => x.Tag.Contains(etag)))
    //                {
    //                    // user has already received data eTag is good so send back as 304 and client will use cache...
    //                    actionContext.Response = actionContext.Request.CreateResponse(System.Net.HttpStatusCode.NotModified);
    //                    SetEtag(actionContext.Response, etag);
    //                    return;
    //                }
    ...
    //            System.Runtime.Caching.MemoryCache.Default.Set(this.CacheKey.ToString(), eTag, null);
    //        }
    //    }
